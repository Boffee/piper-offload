...
- Support PyTorch 2.13 for loading, pinning, streaming, rolling, and block
  ...
  require 0.7.3 or newer, whose production kernels support PyTorch 2.13. The
  Windows `triton` extra requires PyTorch 2.14 to match Triton Windows 3.8;
  the base package permits PyTorch 2.13. Python support is limited to 3.14
  until the required Triton builds support 3.15.
...
[0.9.0]: https://github.com/Boffee/piper-offload/compare/v0.9.0rc3...v0.9.0
